...
const SectionNode = React.memo(({ data, id, onRemoveNode, onEditSectionNode }) => {
    ...
    const handleThumbIconClick = (e) => {
        ...
        if (onEditSectionNode) {
            onEditSectionNode(id); // Call the passed function
        }
    };
        ...
        <div className={`content ${showClose ? 'node-highlighted' : ''}`}
            ...
            <div className=" d-flex flex-column align-items-center w-100">
                ...
                <div className="d-flex align-self-start align-items-center gap-1 mb-3 p-2">
                    ...
                    <p className="default-heading mb-0">Section</p>
                </div>
