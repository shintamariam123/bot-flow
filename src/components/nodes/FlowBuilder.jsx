...
function FlowBuilder() {
  ...
  useEffect(() => {
    ...
    setNodes((nds) =>
      ...
      nds.map((node) => {
        ...
        // Only update nodes that need these specific handlers

        if (node.type === 'interactiveNode') {
  ...
  }, [setNodes, onRemoveNode, spawnConnectedNode, nodes, handleSubscribeToSequence]);
